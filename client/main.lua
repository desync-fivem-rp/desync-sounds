...
-- RegisterNetEvent('InteractSound_CL:PlayWithinDistanceAI')
-- AddEventHandler('InteractSound_CL:PlayWithinDistanceAI', function(otherPlayerCoords, maxDistance, soundFile, soundVolume)
--     hasPlayerLoaded = true

-- 	if hasPlayerLoaded then
-- 		local myCoords = GetEntityCoords(PlayerPedId(-1))
--         local distance = 4.0 --Test
-- 		-- local distance = #(myCoords - otherPlayerCoords)
--         print(soundFile)
...
-- 			SendNUIMessage({
-- 				transactionType = 'playAudio',
-- 				transactionfilePath  = soundFile,
-- 				transactionVolume = soundVolume or standardVolumeOutput
-- 			})
-- 		end
-- 	end
